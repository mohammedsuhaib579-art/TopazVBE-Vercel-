...
export default function DecisionForm({
  ...
  const handleSubmit = () => {
    ...
    const fullDecisions: Decisions = {
      ...
      advertising_trade_press: decisions.advertising_trade_press || {},
      advertising_support: decisions.advertising_support || {},
      advertising_merchandising: decisions.advertising_merchandising || {},
      ...
      deliveries: decisions.deliveries || {},
